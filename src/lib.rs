...
//! # Overview
//!
//! [`tracing`](https://docs.rs/tracing) is a framework for structured,
...
//! [tracing_subscriber::FmtSubscriber]: tracing_subscriber::FmtSubscriber
//! [Write]: Write
//! [NonBlocking]: NonBlocking
//! [WorkerGuard]: WorkerGuard
//! [MakeWriter]: tracing_subscriber::fmt::MakeWriter
//! [non_blocking]: fn@non_blocking
//! [non_blocking module]: mod@non_blocking
//! [daily]: rolling::daily
//! [never]: rolling::never
//!
//!
...
//!  - Using *any* type implementing [Write] in a non-blocking fashion.
...
//! `/some/directory/prefix.YYYY-MM-DD-HH.log`.
//! [daily]  and [never] are the other available options.
//!
//! The file appender implements [Write]. To be used with [tracing_subscriber::FmtSubscriber],
//! it must be combined with a [MakeWriter] implementation to be able to record tracing spans/event.
//!
...
//! ```
//!
//! The [non_blocking module]'s documentation provides
//! more detail on how to use `non_blocking`.
//!
//!
...
#![doc(issue_tracker_base_url = "https://github.com/tokio-rs/tracing/issues/")]
